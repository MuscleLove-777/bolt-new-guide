...
def run(config, prompts=None):
    ...
    try:
        ...
        from seo_optimizer import BoltSEOOptimizer
        ...
        optimizer = BoltSEOOptimizer(config)
    ...
    try:
        from site_generator import BoltSiteGenerator
        site_gen = BoltSiteGenerator(config)
        site_gen.build_site()
